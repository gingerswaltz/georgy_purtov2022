...
/* Игровое поле - пирог размером N*М клеток,
 * последняя клетка пирога - отравлена. 
 * За каждый ход игрок может съесть от 1 до К клеток,
 * начиная с еще не съеденной клетки пирога, 
 * поедая клетки последовательно - справа налево,
 * затем сверху вниз.
 * Тот, кто съест последнюю клетку, проигрывает.*/
